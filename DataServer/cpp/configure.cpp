...
int CONFIG::__initializer()
{
    ...
    try
    {
        ...
        MAXCONNECTION=pData["DATASERVER"]["MAXCONNECTION"];

        STORAGEENGINE_SPLITFACTOR=pData["STORAGEENGINE"]["SPLITFACTOR"];
        STORAGEENGINE_CACHESIZE=pData["STORAGEENGINE"]["CACHE"];

        INDEXER_CACHESIZE=pData["INDEXER"]["CACHESIZE"];
        INDEXER_DATAFILE=pData["INDEXER"]["DATAFILE"];
...
unsigned int CONFIG::STORAGEENGINE_SPLITFACTOR;
unsigned int CONFIG::STORAGEENGINE_CACHESIZE;

unsigned short CONFIG::INDEXER_CACHESIZE;
string CONFIG::INDEXER_DATAFILE;
