...
public:
    ...
    static unsigned int STORAGEENGINE_SPLITFACTOR;
    static unsigned int STORAGEENGINE_CACHESIZE;

    static string INDEXER_DATAFILE;
    static unsigned short INDEXER_CACHESIZE;
