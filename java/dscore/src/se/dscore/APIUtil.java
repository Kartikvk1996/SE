...
public class APIUtil {
    ...
    public static String getObjectAsJson(Object root, String url) {

        String chunks[] = url.split("/");

        try {
            Object obj = getObject(root, chunks, 1, chunks.length);
            if (obj != null) {
    ...
    public static String execute(Object root, String url, JsonObject obj) {

        String chunks[] = url.split("/");
        try {
            Object endObj = getObject(root, chunks, 1, chunks.length - 1);
