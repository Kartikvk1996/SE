...
public:
    Factory(int *eFd,int *sFd,struct epoll_event *ev,struct epoll_event **evs,bool* stopFact,CMS *o)
    {
        eventFd=eFd;
        serverFD=sFd;
        event=ev;
    ...
    else
    {
        ...
        switch(choice)
        {
            case 1  :sendData=object->statusInfo();
                    break;
            case 2  :sendData=object->que->statusInfo(hp->issetGET("showlinks"),3000);
                    break;
            case 3  :   {
            ...
            case 5  :sendData=object->systemInfo();
                    break;
            case 6  :object->shutdown(); *stopFactory=true;
                    break;
